...
```javascript
{
    "data": {
        ...
        "password": "admin",
        "identity": "0",
        "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJhZG1pbiIsImlhdCI6MTYzMDg2MDIwMiwiZXhwIjoxNjMwOTQ2NjAyfQ.Zrxqqd48Cnpg_qU3vwfTq5JS-8MEpAXmriq3lq6P1EU"
    }
}
```
...
| 参数名 | 数据类型     | 参数说明                                   |
| ------ | ------------ | ------------------------------------------ |
| data   | json对象数组 | 要获取的账号数据和数据库中的账号总数length |
...
| id       | string   | 学号/工号                      |
| password | string   | 密码                           |
| identity | string   | 身份(0-管理员 1-学生 2-辅导员) |
...
| 参数名 | 数据类型     | 参数说明                                       |
| ------ | ------------ | ---------------------------------------------- |
| data   | json对象数组 | 要获取的假条数据和数据库中自己假条的总数length |
...
### 5.3. 根据学生id和假条的createdTime获取假条信息

- 请求路径：/leaveforms/:id/:createdTime
- 请求方法：get
- 请求参数
...
| 参数名 | 数据类型     | 参数说明                                                 |
| ------ | ------------ | -------------------------------------------------------- |
| data   | json对象数组 | 要汇总的假条数据和数据库中提交对象是自己的假条总数length |
...
- 请求路径：/leaveforms/:id/:createdTime/state/:isOK
- 请求方法：put
- 请求参数
...
| 参数名 | 数据类型     | 参数说明                                           |
| ------ | ------------ | -------------------------------------------------- |
| data   | json对象数组 | 要获取的体温表数据和数据库中自己的体温表总数length |
...
### 6.3. 根据学生id和体温表的createdTime获取体温表信息

- 请求路径：/temforms/stu/:id/:createdTime
- 请求方法：get
- 请求参数

| 参数名      | 数据类型 | 参数说明       | 备注     |
| ----------- | -------- | -------------- | -------- |
| id          | string   | 学生的学号     | 不能为空 |
...
| 参数名 | 数据类型     | 参数说明                                                     |
| ------ | ------------ | ------------------------------------------------------------ |
| data   | json对象数组 | 要汇总的体温表数据和数据库中提交对象是自己的体温表总数length |
