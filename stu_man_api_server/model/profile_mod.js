...
module.exports = class profile_mod extends require('./model') {
  ...
  static updateStuProfileById(id, body){
    return new Promise(((resolve, reject) => {
      let sql = "update student " + "set class='" + body.class + "',sex='" + body.sex + "',college='" + body.college + "',tel='" + body.tel + "' where id='" + id + "'"
      console.log(sql)
      this.query(sql).then(result_1 => {
        sql = "update user " + "set password='" + body.password + "' where id='" + id + "'"
        console.log(sql)
  ...
  static updateCounProfileById(id, body){
    return new Promise(((resolve, reject) => {
      let sql = "update counselor " + "set sex='" + body.sex + "',college='" + body.college + "',tel='" + body.tel + "' where id='" + id + "'"
      console.log(sql)
      this.query(sql).then(result_1 => {
        sql = "update user " + "set password='" + body.password + "' where id='" + id + "'"
        console.log(sql)
